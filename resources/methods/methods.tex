...
Employing these approximative schemes might introduce some loss of accuracy when comparing with the original charges. However, in practice, as demonstrated in the \textit{Benchmark} section of the aforementioned file, the resulting RMSD values are in the order of thousandths $[e]$ when using double precision and radius of $12$ \AA\, as ACC II does.
